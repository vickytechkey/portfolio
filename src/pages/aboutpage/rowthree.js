        ...
        <React.Fragment>
           <div className="row" data-aos="zoom-in-up">
               <div className="col offset-xl8 offset-l8 s1 m1 xl1 l1">
                ...
                <h1 style={{ marginTop : -55,marginLeft : -55 , fontSize : 45 , lineHeight : 3.6 , fontFamily: ['Poppins', 'sans-serif']}}>Work Experience</h1>
                </div>
                <div className="col s4 m4 xl3 l3 hide-on-med-and-up">
                <h1 style={{ marginTop : -55,marginLeft : -15 , fontSize : 45 , lineHeight : 3.6 , fontFamily: ['Poppins', 'sans-serif']}}>Work Experience</h1>
                </div>
            </div>
            <div className="row">
                ...
                <div className="row" data-aos="zoom-in-up" data-aos-delay="300">
                        ...
                        <h5 style={{fontSize : 20 , lineHeight : 3.6 , fontFamily: ['Poppins', 'sans-serif']}}>Amazon software support engineer- 2020 to present</h5>
                        </div>
                    </div>
                    {/* ends */}
                {/* <div className="row" data-aos="zoom-in-up" data-aos-delay="300">
